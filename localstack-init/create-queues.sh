...
#   league-caddie-events-dev      (main queue)
#   league-caddie-events-dev-dlq  (dead-letter queue)
...
echo "  Main:  http://localhost:4566/000000000000/league-caddie-events-dev"
echo "  DLQ:   http://localhost:4566/000000000000/league-caddie-events-dev-dlq"
