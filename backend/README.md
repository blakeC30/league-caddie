...
```bash
docker exec league_caddie-postgres-1 psql -U league_caddie -d league_caddie_dev -c "
...
|----------|------|---------|-------------|
| `DATABASE_URL` | str | `postgresql://league_caddie:league_caddie@localhost:5432/league_caddie_dev` | PostgreSQL connection string |
