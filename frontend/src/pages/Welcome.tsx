          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {pricingTiers.map((t) => {
              ...
              >
                ...
                <div className={`flex items-center gap-2 text-sm font-medium ${popular ? "text-green-100" : "text-gray-700"}`}>
                ...
                <p className={`text-xs mt-1.5 ${popular ? "text-green-400" : "text-gray-400"}`}>
                  {perMember}
                </p>
              </div>
              );
