  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      if (user?.is_platform_admin) {
        ...
        const league = await leaguesApi.create(name.trim(), penalty, autoAccept);
        ...
        const { url } = await stripeApi.createLeagueCheckout(name.trim(), penalty, selectedTier, autoAccept);
