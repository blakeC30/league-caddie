    ...
    <section className="bg-white rounded-sm border border-ink-200 p-6 space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-base font-bold text-ink-900">Revise Pick</h2>
        </div>
      ...
      {playoffConfig?.status === "active" ? (
        <p className="text-sm text-ink-400">Regular season picks cannot be revised after the playoffs have started.</p>
      ) : (
      <div className="space-y-4">
        <div className="grid sm:grid-cols-3 gap-3">
          {/* Tournament */}
          <div className="space-y-1">
            <label className="text-micro uppercase text-ink-500">Tournament</label>
            <DropdownSelect
        ...
        {duplicatePickConflict && (
          <div className="flex items-start gap-2 bg-flag-50 border border-flag-300 rounded-xs px-4 py-3 text-sm text-flag-700">
        ...
        <div className="flex items-center gap-3">
          ...
          {overridePick.isError && (
            <p className="text-sm text-flag-600">Failed to update pick. Please try again.</p>
          )}
        </div>
      </div>
      )}
